            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Product">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.company.fields.info') }}
                        </th>
                        <th>
                            {{ trans('cruds.company.fields.main_photo') }}
                        </th>
                        <th>
                            {{ trans('cruds.company.fields.subdomain') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                        ...
                        <tr data-entry-id="{{ $company->id }}">
                            ...
                            <td>
                                @if($company->main_photo)
                                    <a href="{{ $company->main_photo }}" target="_blank">
                                        <img src="{{ asset('/tmp/uploads/'.$company->main_photo) }}" width="50px" height="50px">
                                    </a>
                                @endif
                            </td>
                            <td>
