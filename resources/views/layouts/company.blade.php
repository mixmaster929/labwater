...
<html lang="en">
    <head>
        ...
        <!-- ========== Page Title ========== -->
        <title>{{ $company? $company->name : 'Admin Company' }}</title>

        <!-- ========== Favicon Icon ========== -->
        <link rel="shortcut icon" href="assets/img/favicon.png" type="image/x-icon">

        <!-- ========== Start Stylesheet ========== -->
        <link href="{{ asset('company/assets/css/bootstrap.min.css') }}" rel="stylesheet">
        <link href="{{ asset('company/assets/css/font-awesome.min.css') }}" rel="stylesheet">
        <link href="{{ asset('company/assets/css/icofont.min.css') }}" rel="stylesheet">
        <link href="{{ asset('company/assets/css/themify-icons.css') }}" rel="stylesheet">
        <link href="{{ asset('company/assets/css/flaticon-set.css') }}" rel="stylesheet">
        <link href="{{ asset('company/assets/css/magnific-popup.css') }}" rel="stylesheet">
        <link href="{{ asset('company/assets/css/owl.carousel.min.css') }}" rel="stylesheet">
        <link href="{{ asset('company/assets/css/owl.theme.default.min.css') }}" rel="stylesheet">
        <link href="{{ asset('company/assets/css/animate.css') }}" rel="stylesheet">
        <link href="{{ asset('company/assets/css/bootsnav.css') }}" rel="stylesheet">
        <link href="{{ asset('company/assets/css/style.css') }}" rel="stylesheet">
        <link href="{{ asset('company/assets/css/responsive.css') }}" rel="stylesheet">
        <!-- ========== End Stylesheet ========== -->
    </head>
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ route('home') }}">
                        <img src="{{ $company? asset('tmp/uploads/'.$company->main_photo) : asset('company/assets/img/logo-yellow.png') }}" class="logo" alt="Logo">
                    </a>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="content">
                                            ...
                                            <h3 data-animation="animated slideInUp">{{ $company? $company->name : 'Professional Services' }}</h3>
                                            <h2 data-animation="animated slideInDown">{{ $company? $company->name : 'Professional Services' }}</h2>
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="content">
                                            <div class="shape animated slideInLeft"></div>
                                            <h3 data-animation="animated slideInUp">{{ $company? $company->name : 'Professional Services' }}</h3>
                                            <h2 data-animation="animated slideInRight">{{ $company? $company->name : 'Professional Services' }}</h2>
                                            <div class="slider-button">
                                                <a data-animation="animated slideInUp" class="btn btn-theme effect btn-md" href="#">View Projects</a>
                                            </div>
                                        </div>
    ...
    <div class="about-area ver-two overflow-hidden shape-box default-padding-top">
        ...
        <div class="fixed-shape">
            <img src="{{ asset('company/assets/img/shape/1.png') }}" alt="Shape">
        </div>
        <!-- End Fixed Shape -->
        <div class="container">
            <div class="row align-center">
                ...
                <div class="col-lg-5 thumb-box">
                    <div class="thumb">
                        <img src="{{ asset('company/assets/img/illustration/1.png') }}" alt="Thumb">
                    </div>
                </div>
        ...
        <!-- Shape -->
        <div class="shape-bg">
            <img src="{{ asset('company/assets/img/shape.png') }}" alt="Shape">
        </div>
        <!-- End Shape -->
    </div>
    <!-- End Our About -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="services-items services-carousel owl-carousel owl-theme">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <img src="{{ asset('company/assets/img/800x600.png') }}" alt="Thumb">
                            </div>
                            <div class="info">
    ...
    <div class="team-area default-padding-top bottom-less bg-gray">
        <!-- Fixed Shape  -->
        <div class="fixed-shape">
            <img src="{{ asset('company/assets/img/shape/4.svg') }}" alt="Shape">
        </div>
        <!-- End Fixed Shape  -->
        <div class="container">
            <div class="row">
            ...
            <div class="team-items text-center">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 single-item">
                        <div class="item">
                            <div class="thumb">
                                <img src="{{ asset('company/assets/img/700x800.png') }}" alt="Thumb">
                                <div class="info">
                                    <h4>Jessica Jones</h4>
                    ...
                    <div class="col-lg-7 testimonial-box">
                        <div class="testimonial-content testimonials-carousel owl-carousel owl-theme">
                            ...
                            <div class="item">
                                ...
                                <div class="provider">
                                    <div class="thumb">
                                        <img src="{{ asset('company/assets/img/100x100.png') }}" alt="Thumb">
                                    </div>
                                    <div class="info">
                                        <h5>Jones Adhor</h5>
                                        <span>Architect</span>
                    ...
                    <div class="col-lg-6 offset-lg-1 clients-box">
                        <div class="clients-items owl-carousel owl-theme text-center">
                            <div class="single-item">
                                <a href="#"><img src="{{ asset('company/assets/img/150x80.png') }}" alt="Clients"></a>
                            </div>
                            <div class="single-item">
                                <a href="#"><img src="{{ asset('company/assets/img/150x80.png') }}" alt="Clients"></a>
                            </div>
            ...
            <div class="blog-items">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 single-item">
                        <div class="item">
                            <div class="thumb">
                                <a href="blog-single-with-sidebar.html"><img src="{{ asset('company/assets/img/800x600.png') }}" alt="Thumb">
                                </a>
                            </div>
                            <div class="info">
                                <div class="meta">
    ...
    <footer class="bg-dark text-light">
        ...
        <div class="fixed-shape">
            <img src="{{ asset('company/assets/img/shape/footer-shape.png') }}" alt="Shape">
        </div>
        <!-- End Fixed Shape -->
    </footer>
    <!-- End Footer -->
        ...
        <script src="{{ asset('company/assets/js/jquery.appear.js') }}"></script>
        <script src="{{ asset('company/assets/js/jquery.easing.min.js') }}"></script>
        <script src="{{ asset('company/assets/js/jquery.magnific-popup.min.js') }}"></script>
        <script src="{{ asset('company/assets/js/modernizr.custom.13711.js') }}"></script>
        <script src="{{ asset('company/assets/js/owl.carousel.min.js') }}"></script>
        <script src="{{ asset('company/assets/js/wow.min.js') }}"></script>
        <script src="{{ asset('company/assets/js/progress-bar.min.js') }}"></script>
        <script src="{{ asset('company/assets/js/isotope.pkgd.min.js') }}"></script>
        <script src="{{ asset('company/assets/js/imagesloaded.pkgd.min.js') }}"></script>
        <script src="{{ asset('company/assets/js/jquery.simpleLoadMore.js') }}"></script>
        <script src="{{ asset('company/assets/js/count-to.js') }}"></script>
        <script src="{{ asset('company/assets/js/bootsnav.js') }}"></script>
